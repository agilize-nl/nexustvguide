...
export function getActiveRelease(releasesDir) {
...
export function registerAppUpdateRoutes(app, options = {}) {
    const releasesDir = options.releasesDir || path.resolve(process.cwd(), 'data/releases');
    // GET /api/v1/app/version
    app.get('/api/v1/app/version', async (request, reply) => {
    ...
    const handleDownload = async (request, reply) => {
